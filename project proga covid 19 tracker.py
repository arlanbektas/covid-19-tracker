...
window = tk.Tk()  #interacting with tkinter
...
photo= tk.PhotoImage(file = "covid png.png")
photolabel = tk.Label(window,image=photo)
photolabel.grid(row=4, column=0, columnspan=2)
...
deaths_entry = tk.Entry(window, textvariable=var_deaths, state='readonly')
recov_entry = tk.Entry(window, textvariable=var_recov, state='readonly')
